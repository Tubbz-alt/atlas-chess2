...
//char *f1_name="/u1/atlas-chess2-Asic-tests/data/data_h/pre-ampdata-02/chess2_scan_SCurveTest_04162018_board_192.168.3.28_run_N6_BL_744_chargeInjectionEnbled_0_thN_0x6_pixel_num_14_ho_noisecheck_AllPixelsEnabled.root";
char *f1_name="/u1/atlas-chess2-Asic-tests/data/data_h/pre-ampdata-02/chess2_scan_SCurveTest_05162018_board_192.168.3.28_run_N8_BL_744_chargeInjectionEnbled_1_thN_0x6_Bias_-7_hitmap_AllPixelsEnabled_cor.root";
...
for (int asic_num=0;asic_num<3;asic_num++){
   // cv0->cd(asic_num*3+1);
    ...
    TH2D *hist01=(TH2D*)f1->Get(h0_0);
   // hist01_1->GetXaxis()->SetLabelSize(0.02);
   // hist01_1->GetYaxis()->SetLabelSize(0.02);
    ...
    if (asic_num==0){
       ...
       hist01->GetYaxis()->SetRange(1,128);
       ...
       hist01->GetZaxis()->SetLabelFont(42);
       hist01->GetZaxis()->SetLabelSize(0.035);
       hist01->GetZaxis()->SetTitleSize(0.035);
       hist01->GetZaxis()->SetTitleFont(42);
       hist01->Draw("box");
       pad1->Modified();
       hist01->Draw("box");hist01->SetFillColor(2);hist_m0=hist01;}//sprintf(p_col0,"chess2_matrix%i_p_col",asic_num);pro_col=TH1D(p_col0,"proj_col",32,0,32);cv2->cd(asic_num*2+1);pro_col=hist01.ProjectionX("_col",0,-1,"col");pro_col->Draw();sprintf(p_row0,"chess2_matrix%i_p_row",asic_num);pro_row=TH1D(p_row0,"proj_row",128,0,128);pro_row=hist01.ProjectionY("_row",0,-1,"row");cv2->cd(asic_num*2+2);pro_row->Draw();}
    else {
    ...
    hist01_inve->GetXaxis()->SetRange(1,32);
    ...
    hist01_inve->GetYaxis()->SetRange(1,128);
    ...
    hist01_inve->GetZaxis()->SetLabelFont(42);
    hist01_inve->GetZaxis()->SetLabelSize(0.035);
    hist01_inve->GetZaxis()->SetTitleSize(0.035);
    hist01_inve->GetZaxis()->SetTitleFont(42);
    ...
    TH1D *hist01y=(TH1D*)f1->Get(h0_3);

    hist01y->GetYaxis()->SetTitle("counts_number");
    hist01y->Draw("");hist01y->SetLineColor(co1);hist01y->SetLineWidth(0.3);hist01y->GetXaxis()->SetLabelSize(0.04);
    
    //cv1->cd(asic_num*2+2);
    //sprintf(h0_4,"chess2_matrix%i_allhit_th",asic_num);
    //TH1D *hist01x=(TH1D*)f1->Get(h0_4);
...
p_col0->GetXaxis()->SetLabelSize(0.05);
p_col0->GetXaxis()->SetTitleSize(0.06);
p_col0->GetXaxis()->SetTitleOffset(0.49);
p_col0->GetYaxis()->SetLabelSize(0.05);
p_col0->GetYaxis()->SetTitleSize(0.06);
p_col0->GetYaxis()->SetTitleOffset(0.53);
...
p_row0->GetXaxis()->SetLabelSize(0.05);
p_row0->GetXaxis()->SetTitleSize(0.06);
p_row0->GetXaxis()->SetTitleOffset(0.49);
p_row0->GetYaxis()->SetLabelSize(0.05);
p_row0->GetYaxis()->SetTitleSize(0.06);
p_row0->GetYaxis()->SetTitleOffset(0.53);
