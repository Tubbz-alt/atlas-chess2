...
export SLAC_DIR=/usr/local/chess2/chess2/atlas-chess2
export FEB_DIR=${SLAC_DIR}/firmware/common/AtlasChess2Feb
export SURF_DIR=${SLAC_DIR}/firmware/submodules/surf
export ROGUE_DIR=${SLAC_DIR}/software/rogue
